...
Keep all function declarations on one line including the opening brace:
...
This style guide was forked from [Ray Wenderlich's Swift Style Guide](https://github.com/raywenderlich/swift-style-guide)
